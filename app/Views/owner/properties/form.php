  ...
  <div class="lg:col-span-2 space-y-4">
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-soft p-5 space-y-3">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
        ...
        <div><label class="text-sm font-medium mb-1 block">Facebook URL</label><input type="text" name="facebook_url" value="<?= e($property['facebook_url'] ?? '') ?>" class="w-full px-3 py-2 rounded-lg border border-slate-300"></div>
